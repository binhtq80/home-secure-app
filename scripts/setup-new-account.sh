...
echo "   2. Update scripts/env.${ENV}.sh with the discovered resource IDs above"
echo "   3. Seed test data: ENV=$ENV node scripts/seed-energy-data.js"
echo "   4. Update .github/workflows/*.yml with new role ARN and resource IDs"
echo ""
